...
# Initialize NLTK - download all required resources
...
nltk.download('punkt_tab')  # Fixed: Add punkt_tab resource that was missing
nltk.download('averaged_perceptron_tagger')  # Common requirement for NLP
